...
namespace Loki.Utils
{
    ...
    public class WinConsole
    {
        ...
        [DllImport("kernel32")]
        static extern bool SetConsoleTextAttribute(IntPtr hConsoleOutput, WinConsoleColor wAttributes);
        ...
        [DllImport("kernel32")]
        static extern int FillConsoleOutputAttribute(IntPtr buffer, WinConsoleColor wAttribute, int length, Coord position, out int written);
        ...
        struct ConsoleScreenBufferInfo
        {
            ...
            public WinConsoleColor Attributes;
        ...
        public static void Initialize()
        {
            ...
            Stream s = System.Console.OpenStandardInput(_DefaultConsoleBufferSize);
            ...
            // Set up System.Console.Out
            StreamWriter writer = null;
            s = System.Console.OpenStandardOutput(_DefaultConsoleBufferSize);
            if (s == Stream.Null)
            ...
            s = System.Console.OpenStandardError(_DefaultConsoleBufferSize);
            if (s == Stream.Null)
                writer = StreamWriter.Null;
            else
            {
        ...
        public static void Clear()
        {
            ...
            FillConsoleOutputAttribute(buffer, WinConsole.Color, info.Size.X * info.Size.Y, new Coord(), out writtenChars);
        ...
        public static Coord CursorPosition
        {
            ...
            {
                Initialize();
                SetConsoleCursorPosition(buffer, value);
            }
        }
        ...
        public static Coord BufferSize
        {
            ...
            set
            {
                if (buffer != IntPtr.Zero)
                    SetConsoleScreenBufferSize(buffer, value);
            }
        }
        ...
        public void RedirectDebugOutput(bool clear, WinConsoleColor color, bool beep)
        {
            if (clear)
            {
            ...
            Debug.Listeners.Add(new TextWriterTraceListener(new ConsoleWriter(System.Console.Error, color, WinConsoleFlashMode.FlashUntilResponse, beep), "console"));
        }
        ...
        public void RedirectTraceOutput(bool clear, WinConsoleColor color)
        {
            if (clear)
            {
            ...
            Trace.Listeners.Add(new TextWriterTraceListener(new ConsoleWriter(System.Console.Error, color, 0, false), "console"));
        }
        ...
        /// <summary>
        /// Returns the error stream (same as System.Console.Error)
        /// </summary>
        ...
        /// <summary>
        /// Returns the input stream (same as System.Console.In)
        /// </summary>
        ...
        /// <summary>
        /// Returns the output stream (same as System.Console.Out)
        /// </summary>
